...
namespace nilnul.num._real_._TEST_.op_.unary_.ln_.byReverseExp
{
	[TestClass]
	public class UnitTest1
	{
		...
		///*	var r = nilnul*/.num.real_.positive.ln_._ByReverseExpX.Ln(2);//

			ofOriginIndex("0.69314718056", 2);
		...
		public void ofOriginIndex(string origin, Real index)
		{
		...
		public void ofOriginIndex(string origin, RealI index)
		{
			...
			var r = nilnul.num.real_.positive.ln_._ByReverseExpX.RetReal(index);
