...
namespace nilnul.num._real_._TEST_.op_.unary_.tg.ofIrrational
{
	[TestClass]
	public class UnitTest1
	{
		...
		public void ofOriginIndex(string origin, nilnul.num.RealI index)
		{
			...
			var r = nilnul.num.real.op_.unary_._TgX.RealI(index).ToReal();
