...
namespace nilnul.num._real_._TEST_.op_.binary_.pow.radicR_.indexR_
{
	[TestClass]
	public class UnitTest12
	{
		...
		{
			var radic = nilnul.num.real_.nonneg.op_.unary_._SqrtX.RetRealI(3);
			var index = nilnul.num.real_.nonneg.op_.unary_._SqrtX.RetRealI(2);


			var r = "2.17458142819";
			ofOriginIndex("2.174581428191967", radic, index);
