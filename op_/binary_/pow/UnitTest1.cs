...
namespace nilnul.num._real_._TEST_.op_.binary_.pow
{
	[TestClass]
	public class UnitTest1
	{
		...
		{
			var radic = new nilnul.num.Quotient1(1, 2);
			var index = new nilnul.num.Quotient1(7, 3);



			ofOriginIndex("0.19842513149", radic, index);
